...
MACRO_CONFIG_INT(HttpAllowInsecure, http_allow_insecure, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SERVER, "Allow insecure HTTP protocol in addition to the secure HTTPS one. Mostly useful for testing.")
