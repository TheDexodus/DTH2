...
static PyMethodDef API_InputMethods[] = {
	...
	{"set_block_user_input", API_Input_setBlockUserInput, METH_VARARGS, "set_block_user_input(block)"},
	{"show_cursor", API_Input_showCursor, METH_VARARGS, "show_cursor(is_visible)"},
	{"get_mouse_position", API_Input_getMousePosition, METH_NOARGS, "get_mouse_position() -> Vector2"},
	{"get_cursor_position", API_Input_getCursorPosition, METH_NOARGS, "get_cursor_position() -> Vector2"},
	{"get_target_position", API_Input_getTargetPosition, METH_NOARGS, "get_target_position() -> Vector2"},
	{"is_human_like_move_ended", API_Input_isHumanLikeMoveEnded, METH_NOARGS, "is_human_like_move_ended() -> bool"},
	{"set_target", API_Input_setTarget, METH_VARARGS, "set_target(position)"},
	{"set_target_human_like", API_Input_setTargetHumanLike, METH_VARARGS, "set_target_human_like(position, move_time=None, on_arrived=None)"},
	{"move_mouse_to_player", API_Input_moveMouseToPlayer, METH_VARARGS, "move_mouse_to_player(player_id, move_time=None, on_arrived=None)"},
	{"remove_moving", API_Input_removeMoving, METH_NOARGS, "remove_moving()"},
	{"set_wanted_weapon", API_Input_setWantedWeapon, METH_VARARGS, "set_wanted_weapon(weapon)"},
	{"cancel_human_like", API_Input_cancelHumanLike, METH_VARARGS, "cancel_human_like()"},
